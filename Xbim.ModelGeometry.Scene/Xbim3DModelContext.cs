...
namespace Xbim.ModelGeometry.Scene
{
    ...
    public class Xbim3DModelContext : ICanLog
    {
        ...
        /// <summary>
        /// Gets the polylines optionally generated by <see cref="CreateContext()" /> with entity label and vertices.
        /// </summary>
        ...
        /// <param name="generatePolylines">When <c>true</c> creates polylines from curves.</param>
        /// <returns></returns>
        ...
        private void GetPolylines(XbimCreateContextHelper contextHelper)
        {
            ...
            Polylines = polylines.ToDictionary<KeyValuePair<int, List<XbimPoint3D>>, int, IReadOnlyList<XbimPoint3D>>(
